...
const presets = [
  ...
  { day: "hump", answer: "YES", emoji: "🐪", color: "#d97706", qcolor: "#451a03", bg: "#fef3c7" },
  { day: "pay", answer: "SOON", emoji: "💸", color: "#16a34a", qcolor: "#14532d", bg: "#dcfce7" },
  ...
  { day: "sick", answer: "WISH", emoji: "🤒", color: "#65a30d", qcolor: "#365314", bg: "#ecfccb" },
  { day: "snow", answer: "NO", emoji: "❄️", color: "#0284c7", qcolor: "#0c4a6e", bg: "#e0f2fe" },
  { day: "pool", answer: "YES", emoji: "🎱", color: "#fef08a", qcolor: "#fafafa", bg: "#14532d" },
